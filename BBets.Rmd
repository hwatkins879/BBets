...
<!--Decide on your methods:  In this section
explain the approach you will take to attack the issue --- how will you decide on a likely estimate of professor Brownlow's earnings or losses after 637 bets. Also explain how you construct a 95% confidence interval about your estimate of his winnings !-->
...
A class size of 28 is ideal, but it does not bring Brownlow's earnings to exactly zero. Achieving zero earnings would require a fractional number of students, which is not feasible. At a class size of 29, earnings are approximately $29, while at a class size of 28, earnings are around -$23. Therefore, a class size of 28 is the best option to bring Brownlow's earnings as close to zero as possible. This conclusion was reached through trial and error.
